        ...
        <div class="card">
            ...
            <div class="tabpanel" data-tabpanel="documents">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row-actions">
                                    <a href="{{ route('records.document.download', $doc) }}"
                                        class="btn-ghost">Download</a>
                                    @if(($role === 'hr_admin' || $role === 'super_admin') && $doc->status === 'pending')
                                    <form method="POST" action="{{ route('records.document.verify', $doc) }}">
                ...
                @if(($role === 'hr_admin' || $role === 'super_admin') || $isSelf)
                <form method="POST" action="{{ route('records.document.upload', $viewed) }}"
